...
The will_paginate plugin - With the addition of pagination, you will need to add Mislav's will_paginate plugin to your vendor/plugins directory.  See https://github.com/mislav/will_paginate/tree/master
